...
export default function Hero() {
  return (
    <section id="home" className="relative w-full h-[100vh] md:h-screen">
      {heroImage && (
        <Image
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white px-4 md:px-12 lg:px-24 w-full gap-8 md:flex-row md:justify-between md:text-left">
