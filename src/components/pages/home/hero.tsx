...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen w-full">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white px-4 md:px-12 lg:px-24">
        <h1 className="font-headline text-2xl md:text-4xl font-bold uppercase tracking-tight drop-shadow-lg">
          Moving Your World,
          <br />
