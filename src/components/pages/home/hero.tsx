...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen w-full">
      ...
      <div className="relative z-10 flex h-full flex-col items-start justify-center text-white px-4 md:px-12 lg:px-24">
        ...
        <div className="mt-8">
          <Button asChild variant="accent" size="lg" className="transition-all duration-300 transform hover:scale-105 shadow-lg">
